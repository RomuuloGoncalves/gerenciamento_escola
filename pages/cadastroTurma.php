    ...
    <div class="container">
        ...
        <form action="../functions/realizarCadastroTurma.php" method="POST">
            ...
            <div class="campo">
                ...
                <input type="number" id="vagas" name="vagas" value="<?= isset($dados['vagas']) ? $dados['vagas'] : ''; ?>">
                <span class="erro"><?= isset($erros['vagas']) ? $erros['vagas'] : ''; ?></span>
            </div>

            <div class="campo">
                <label class="label_formulario" for="data">Data:</label>
                <input type="date" id="data" name="data" value="<?= isset($dados['data']) ? $dados['data'] : ''; ?>">
                <span class="erro"><?= isset($erros['data']) ? $erros['data'] : ''; ?></span>
            </div>

            <div class="campo">
                <label class="label_formulario" for="descricao">Descrição</label>
                <textarea id="descricao" rows="5" name="descricao"><?= isset($dados['descricao']) ? $dados['descricao'] : ''; ?></textarea>
